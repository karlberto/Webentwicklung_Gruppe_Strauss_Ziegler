        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form action="<?= base_url('Projekte/index') ?>" method="post">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $chosenProjekt['id'] ?>">
                    <input class="form-control" id="name" name="name" type="text" value="<?= $chosenProjekt['name'] ?>">
                    <div class="p-2"></div>
                    <div class="form-group">
                        <label for="beschreibung">Projektbeschreibung:</label>
                        <input class="form-control" id="beschreibung" name="beschreibung" value="<?= $chosenProjekt['beschreibung'] ?>"></input>
                    </div>
                    <div class="p-2"></div>
