        ...
        <div class="row">
            ...
            <div class="col-8">
                    ...
                    <?php foreach($reiterdata as $item) { ?>
                        <tr>
                            ...
                            <td class="text-primary">
                                ...
                                <a href="<?= base_url('Reiter/index/1/') ?>">
                ...
                <form action="<?= base_url('Reiter/index/') ?>" method="post">
                    <input type="hidden" class="form-control" id="old_name" name="old_name" value="<?= $chosenReiter['name'] ?>">
                    <label for="name">Reitername:</label>
                    <input class="form-control" id="name" name="name" type="text" value="<?= $chosenReiter['name'] ?>">
                    <div class="p-2"></div>
                    <div class="form-group">
                        <label for="beschreibung">Reiterbeschreibung:</label>
                        <input class="form-control" id="beschreibung" name="beschreibung" value="<?= $chosenReiter['beschreibung'] ?>"></input>
                    </div>
                    <div class="p-2"></div>
                    <button type="submit" name="btnBearbeitenSpeichern" id="btnBearbeitenSpeichern" class="btn btn-primary">Speichern</button>
