...
class CodeIgniter
{
    ...
    public function run(?RouteCollectionInterface $routes = null, bool $returnResponse = false)
    {
        ...
        if ($this->context === null) {
            throw new LogicException('Context must be set before run() is called. If you are upgrading from 4.1.x, you need to merge `public/index_page.php` and `spark` file from `vendor/codeigniter4/framework`.');
        }
