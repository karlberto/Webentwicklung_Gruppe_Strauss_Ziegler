...
class IncomingRequest extends Request
{
     ...
     *
     * @param array|string|null $index  ProjektPage for item to fetch from $_GET.
     ...
     *
     * @param array|string|null $index  ProjektPage for item to fetch from $_POST.
     * @param int|null          $filter A filter name to apply
     * @param mixed             $flags
     *
     * @return mixed
     ...
     *
     * @param array|string|null $index  ProjektPage for item to fetch from $_POST or $_GET
     * @param int|null          $filter A filter name to apply
     * @param mixed             $flags
     *
     * @return mixed
     ...
     *
     * @param array|string|null $index  ProjektPage for item to be fetched from $_GET or $_POST
     * @param int|null          $filter A filter name to apply
     * @param mixed             $flags
     *
     * @return mixed
     ...
     *
     * @param array|string|null $index  ProjektPage for item to be fetched from $_COOKIE
